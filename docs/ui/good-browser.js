...
function handleGoodBrowser(scripts) {
    ...
    if (navigator.appName.indexOf("Microsoft") >= 0) { // bad browser
        ...
        document.write("<br/><p>Oh, " + navigator.appName + "? Nice try&hellip; <big>&#x263a;</big></p><br/><p>Sorry, such thing cannot be supported, as it does not provide minimal functionality required. Please use one of the major Web browsers.</p>");
    } //if
