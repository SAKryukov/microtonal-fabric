...
const findControls = () => {
    ...
    const usage = (function defineButtons() {
        ...
        return {
            ...
            GainCompensation: stateButtons[8],
        ...
        tables: {
            ...
            compensation: {
                ...
                middleFrequency: new Slider(
                    { value: defaultInstrument.gainCompensation.middleFrequency, min: 20, max: 8000, step: 0.1, indicatorWidth: "5.5em", indicatorSuffix: " Hz" },
                ...
                lowFrequencyCompensationGain: new Slider(
                    {value: defaultInstrument.gainCompensation.lowFrequencyCompensationGain, min: 0, max: 500, step: 0.00001, indicatorWidth: "6em"},
                ...
                highFrequencyCompensationGain: new Slider(
                    {value: defaultInstrument.gainCompensation.highFrequencyCompensationGain, min: 0, max: 500, step: 0.0001, indicatorWidth: "6em"},
